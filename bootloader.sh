...
for variant in ${DTB_VARIANTS}; do
    ...
    #    -k /tmp/kernel-dtb -r ${MOUNTED_IMAGE_DIR}/boot/initrd-6.11.0-35.gb87e886-sdm845

    mkbootimg --kernel ${MOUNTED_IMAGE_DIR}/boot/Image-6.11.0-35.gb87e886-sdm845 --dtb ${MOUNTED_IMAGE_DIR}/boot/dtb/qcom/sdm845-${DTB_VENDOR}-${variant}.dtb --pagesize 4096 \
